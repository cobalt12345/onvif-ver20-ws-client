...
import ru.sitronics.antidrone.onvif.device.DeviceServiceCapabilities;
import ru.sitronics.antidrone.onvif.events.EventPortType;
import ru.sitronics.antidrone.onvif.events.GetEventProperties;
import ru.sitronics.antidrone.onvif.events.GetEventPropertiesResponse;
import ru.sitronics.antidrone.onvif.ptz.Capabilities2;
import ru.sitronics.antidrone.onvif.imaging.ImagingPort;
import ru.sitronics.antidrone.onvif.media.ver10.AudioSource;
import ru.sitronics.antidrone.onvif.media.ver10.Media;
import ru.sitronics.antidrone.onvif.media.ver10.Profile;
import ru.sitronics.antidrone.onvif.media.ver10.VideoSource;
import ru.sitronics.antidrone.onvif.ptz.PTZ;
import ru.sitronics.antidrone.onvif.ptz.PTZPreset;
import ru.sitronics.antidrone.onvif.ptz.PTZStatus;
import ru.sitronics.onvif.beans.DeviceInfo;
import ru.sitronics.onvif.soap.OnvifDevice;
import ru.sitronics.onvif.utils.OnvifUtils;
  ...
  public static String inspect(OnvifDevice device) {
    ...
    try {
      ...
      if (imaging != null && videoSources.size() > 0) {
        ...
        try {
          ru.sitronics.antidrone.onvif.imaging.Capabilities2 image_caps = imaging.getServiceCapabilities();
    ...
    if (ptz != null) {
      ...
      try {
        ru.sitronics.antidrone.onvif.ptz.Capabilities2 ptz_caps = ptz.getServiceCapabilities();
        out += "PTZ:" + sep;
